...
| Item | Situação | Etapa |
|---|---|---|
| **Logotipo em vetor** | O `logo.png` do site atual foi baixado na Etapa 8 e é o logotipo REAL: dele saem o favicon, o apple-touch-icon, os ícones do manifest, a marca da og-image e — desde 13/09/2026 — o disco do cabeçalho. Ele tem 240×60, e o disco dentro dele 58×58. **No cabeçalho isso não é problema:** o disco é desenhado a 28px com `densities={[1, 2]}`, então o 2× pede 56px e cabe nos 58 originais — é redução, não ampliação. **O que continua macio é o `apple-touch-icon` de 180px**, que é ampliação de 3×. Um SVG ou um PNG grande resolveria. **Não redesenhei o disco em SVG de propósito:** um logotipo traçado a olho de um raster de 58px sai *quase* igual, e quase igual em identidade de marca é pior que macio. | 8 · 12 · 13 |
