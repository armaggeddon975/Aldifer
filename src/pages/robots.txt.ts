...
export const GET: APIRoute = ({ site }) => {
  ...
  const linhas = [
    ...
    'Allow: /',
    '',
    '# Painel do Keystatic (Etapa 11). Bloqueado desde já: quando a rota',
    '# existir, ela não deve ser rastreada nem indexada, e um robots.txt',
    '# atualizado depois do lançamento chega tarde.',
    'Disallow: /admin',
    'Disallow: /admin/',
    '',
